...
<body class="bg-gray-50 text-gray-800 antialiased">
  ...
  <header class="relative bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-600 text-white overflow-hidden">
    ...
    <div class="relative container mx-auto px-4 py-20 text-center">
      <h1 class="text-5xl font-bold mb-4 drop-shadow">EecycleHub</h1>
  ...
  <section class="py-16 px-4">
    <div class="container mx-auto max-w-4xl text-center">
      <h2 class="text-4xl font-bold text-teal-700 mb-6">Why EecycleHub?</h2>
      <div class="bg-white p-10 rounded-2xl shadow">
        <p class="text-lg text-gray-700 leading-relaxed">
          Every day, reusable products like clothes, electronics, furniture, and books end up in landfills. EcycleHub connects donors with organizations that repurpose these items, reducing waste and supporting a greener future.
        </p>
      </div>
    </div>
  </section>
    ...
    <div class="container mx-auto px-6">
      <div class="flex flex-col md:flex-row justify-between items-center md:items-start gap-10">
        <div class="text-center md:text-left">
          <h2 class="text-2xl font-semibold mb-2">EecycleHub</h2>
